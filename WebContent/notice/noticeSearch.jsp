...
<body>
  ...
  <%
	...
	<br>
		<input type="button" value="게시글 전체보기" onClick="location.href='noticeList.no'">
	<br>
	...
	<th>작성자</th>
		...
		<%
			for (int i = 0; i < noticeSearchList.size(); i++) {
					...
					String noticeDate = noticeDTO.getNotiDate(); 
					String timeY = noticeDate.substring(2, 4);
					String timeM = noticeDate.substring(5, 7); 
					String timeD = noticeDate.substring(8, 10); 
					String noticeTimeMDY = timeM + "/" + timeD + "/" + timeY; 
					String noticeTimeMD = timeM + "/" + timeD; 
		%>
